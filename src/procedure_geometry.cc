...
void create_cube(std::vector<glm::vec4>& cube_vertices, 
	...
	// cube_normals.push_back(glm::vec4(0.0, 0.0, -1.0, 0.0));
	// cube_normals.push_back(glm::vec4(0.0, 0.0, -1.0, 0.0));
	...
	// cube_normals.push_back(glm::vec4(0.0, -1.0, 0.0, 0.0));
	// cube_normals.push_back(glm::vec4(0.0, -1.0, 0.0, 0.0));
	...
	// cube_normals.push_back(glm::vec4(1.0, 0.0, 0.0, 0.0));
	// cube_normals.push_back(glm::vec4(1.0, 0.0, 0.0, 0.0));
...
void create_offsets(std::vector<glm::vec3>& offsets) {
	// offsets.push_back(glm::vec3(10.0, 0.0, 0.0));
	// offsets.push_back(glm::vec3(30.0, 0.0, 0.0));
	offsets.push_back(glm::vec3(0.0, 10.0, 0.0));
	offsets.push_back(glm::vec3(0.0, 20.0, 0.0));
	offsets.push_back(glm::vec3(0.0, 30.0, 0.0));
}
